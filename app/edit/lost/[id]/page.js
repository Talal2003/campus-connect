...
export default function EditLostItem({ params }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setTimeout(() => {
        router.push(`/lost/${originalItem.id}`);
      }, 2000);
  ...
  return (
    <div className="container" style={{ maxWidth: '800px', margin: '2rem auto' }}>
      <Link href={`/lost/${params.id}`} style={{
        display: 'inline-flex',
        alignItems: 'center',
        color: 'var(--primary-blue)',
        marginBottom: '1rem',
      ...
      <div className="card" style={{ padding: '2rem' }}>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div style={{ marginBottom: '1.5rem' }}>
            ...
            <div className="form-group">
              <label htmlFor="building">Building where item was lost*</label>
              <select
                id="building"
                name="building"
                className="form-control"
